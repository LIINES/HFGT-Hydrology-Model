# load_simulation3.jl
# Run Code for Simulation 3: System with 3 Lakes, 3 Land Segments
...
file_path = "0-Data/1-IntermediateData/HDF5s/myLFES-Full-Simulation 3-Default-Base-2.hdf5"
...
concentration_plot = plot_buffer_timeseries(lake_concentrations, time, names_lakes,
                                "Time (weeks)",
                                 "Concentration (mg/L)",
                                 "Simulation 3: Lake Concentration Over Time",
                                 "0-Data/2-FinalData/LakeConcentrations/sim3_lakeconc",
